...
public class Orders {
    ...
    public Node getView() {
        ...
        table.getChildren()
                .add(createOrderRow("#ORD124", "Tomato (50 kg)", "₹1,000", "Pending", "May 12, 2025", false));
        table.getChildren()
                .add(createOrderRow("#ORD123", "Onion (100 kg)", "₹1,800", "Completed", "May 10, 2025", false));
        table.getChildren()
                .add(createOrderRow("#ORD122", "Potato (75 kg)", "₹1,125", "Completed", "May 8, 2025", false));
        table.getChildren()
                .add(createOrderRow("#ORD121", "Wheat (200 kg)", "₹4,800", "Cancelled", "May 5, 2025", false));
    ...
    private Button createChip(String text, boolean active) {
        ...
        if (active) {
            b.setStyle(
                    "-fx-background-color: #117864; -fx-text-fill: white; -fx-font-weight: bold; -fx-background-radius: 20px; -fx-padding: 4 14; -fx-cursor: hand;");
        } else {
            b.setStyle(
                    "-fx-background-color: #FFFFFF; -fx-border-color: #A2D9CE; -fx-border-radius: 20px; -fx-background-radius: 20px; -fx-text-fill: #1B2631; -fx-padding: 4 14; -fx-cursor: hand;");
        }
        return b;
    }
    ...
    private HBox createOrderRow(String id, String prod, String amt, String status, String date, boolean isHeader) {
        ...
        if (isHeader) {
            ...
            row.setStyle(
                    "-fx-background-color: #D4EFDF; -fx-background-radius: 12px 12px 0 0; -fx-border-color: #A2D9CE; -fx-border-width: 0 0 1 0;");
            ...
            if ("Pending".equalsIgnoreCase(status)) {
                statLbl.setStyle(
                        "-fx-background-color: #FCF3CF; -fx-text-fill: #B7950B; -fx-font-weight: bold; -fx-padding: 3 8; -fx-background-radius: 10px;");
            } else if ("Completed".equalsIgnoreCase(status)) {
                statLbl.setStyle(
                        "-fx-background-color: #D4EFDF; -fx-text-fill: #117864; -fx-font-weight: bold; -fx-padding: 3 8; -fx-background-radius: 10px;");
            } else {
                statLbl.setStyle(
                        "-fx-background-color: #FADBD8; -fx-text-fill: #C0392B; -fx-font-weight: bold; -fx-padding: 3 8; -fx-background-radius: 10px;");
            }

            Button viewBtn = new Button("View");
            viewBtn.setStyle(
                    "-fx-background-color: transparent; -fx-border-color: #A2D9CE; -fx-border-radius: 6px; -fx-cursor: hand;");
