...
public class CropPrices {
        ...
        private final CropPriceController controller = new CropPriceController();

        private final ComboBox<String> stateBox = new ComboBox<>();

        private final ComboBox<String> districtBox = new ComboBox<>();

        private final ComboBox<String> marketBox = new ComboBox<>();

        private final TableView<CropPrice> table = new TableView<>();
        ...
        public Node getView() {
                ...
                TableColumn<CropPrice, String> cropColumn = new TableColumn<>("Crop");
                ...
                TableColumn<CropPrice, String> minColumn = new TableColumn<>("Min Price");
                ...
                TableColumn<CropPrice, String> maxColumn = new TableColumn<>("Max Price");
                ...
                TableColumn<CropPrice, String> modalColumn = new TableColumn<>("Modal Price");
                ...
                TableColumn<CropPrice, String> marketColumn = new TableColumn<>("Market");
                ...
                TableColumn<CropPrice, String> varietyColumn = new TableColumn<>("Variety");
                ...
                TableColumn<CropPrice, String> dateColumn = new TableColumn<>("Date");
                ...
                stateBox.setOnAction(e -> {
                        ...
                        Thread thread = new Thread(() -> {
                                ...
                                try {
                                        ...
                                        var districts = controller.getDistricts(
                                                        state);
                ...
                districtBox.setOnAction(e -> {
                        ...
                        Thread thread = new Thread(() -> {
                                ...
                                try {
                                        ...
                                        var markets = controller.getMarkets(
                                                        state,
                                                        district);
        ...
        private void loadPrices(
                ...
                Thread thread = new Thread(() -> {
                        ...
                        try {
                                ...
                                var prices = controller.getCropPrices(
                                                state,
                                                district,
                                                market);
