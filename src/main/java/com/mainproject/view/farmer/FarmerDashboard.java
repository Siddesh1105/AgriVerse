...
public class FarmerDashboard {
        ...
        private VBox createSidebar() {
                ...
                Circle farmerCircle = new Circle(
                                22,
                                Color.web(
                                                PANEL_BG));

                Label farmerEmoji = new Label(
                                "👨‍🌾");

                StackPane farmerAvatar = new StackPane(
                                farmerCircle,
                                farmerEmoji);
        ...
        private ToggleButton createNavigationButton(
                ...
                button.selectedProperty()
                                .addListener(
                                                (obs, oldValue, newValue) -> updateStyle.run());
        ...
        public void navigateTo(String page) {
                ...
                switch (page) {
                        ...
                        case "Notifications":
                                ...
                                viewNode = new Notifications(this)
                                                .getView();
