...
public class RentalRequests {
    ...
    private VBox createRentalCard(
        ...
        // Payment status is shown separately from rental status so the
        // equipment owner can immediately see whether the accepted rental
        // has actually been paid for.
        String paymentValue = safe(rental.getPaymentStatus());
