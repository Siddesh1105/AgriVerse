...
public class AdminDashboard extends Application {
    ...
    public void showDashboard() {
        ...
        // Always open Dashboard Overview from the top so cards are not clipped
        // after returning from another admin page.
        dashboardScrollPane.setVvalue(0);
        dashboardScrollPane.setPannable(true);
        StackPane.setAlignment(dashboardScrollPane, Pos.TOP_LEFT);
        ...
        Platform.runLater(() -> dashboardScrollPane.setVvalue(0));
    ...
    private VBox buildDashboardView() {
        ...
        view.setPadding(new Insets(0, 0, 30, 0));
    ...
    private GridPane buildStatsGrid() {
        ...
        grid.add(createStatCard("📦", "Total Products", String.valueOf(products.size()), "Live Firestore data", true), 3, 0);
        grid.add(createStatCard("🧾", "Total Orders", String.valueOf(orders.size()), "Live Firestore data", true), 0, 1);
    ...
    private VBox createStatCard(
        ...
        valueLabel.setTextFill(Color.web("#1B2631"));
    ...
    private TableView<Order> buildOrdersTable() {
        ...
        TableColumn<Order,String> status = new TableColumn<>("Payment Status");
        ...
        table.setRowFactory(tv -> {
            ...
            row.setOnMouseClicked(e -> { if (!row.isEmpty()) showOrderDetails(row.getItem()); });
            return row;
        });
        return table;
    }
    ...
    private LineChart<String, Number> buildRevenueChart() {
        ...
        for (int i = shown - 1; i >= 0; i--) {
            ...
            String label = o.getOrderDate() == null ? "Order " + (shown-i) : o.getOrderDate().toString().substring(0, Math.min(10, o.getOrderDate().toString().length()));
